...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2024 at 07:36 AM
...
INSERT INTO `tbl_asesmen` (`no`, `asesmen`) VALUES
(1, 'FR.Ak.01 Persetujuan Asesmen dan Kerahasiaan');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_data_tuk`
--

CREATE TABLE `tbl_data_tuk` (
  `no` int(11) NOT NULL,
...
--
-- Dumping data for table `tbl_data_tuk`
--

INSERT INTO `tbl_data_tuk` (`no`, `kode`, `nama`, `jenis`, `penanggung_jawab`, `alamat`) VALUES
(1, 'TUK23122023001', 'UNIVERSITAS PROKLAMASI 45', 'Sewaktu', 'Niken Widyastuti', 0),
(2, 'TUK23122023001', 'UNIVERSITAS PELITA HARAPAN', 'Sewaktu', 'Yokie', 0),
(3, 'TUK23122023001', 'UNIVERSITAS NASIONAL', 'Sewaktu', 'Niken Widyastuti', 0);
...
CREATE TABLE `tbl_form` (
  `id` int(11) NOT NULL,
  `skema` varchar(128) NOT NULL,
  `tuk` varchar(128) NOT NULL,
  `nama_kampus` varchar(128) DEFAULT NULL,
  ...
  `pendidikan_terakhir` enum('SMA','D1','D2','D3','S1','S2','S3') NOT NULL,
  `alamat_rumah` text NOT NULL,
  `nama_pekerjaan` varchar(128) DEFAULT NULL,
  `nama_perusahaan` varchar(128) DEFAULT NULL,
  `jabatan` varchar(128) DEFAULT NULL,
  `alamat_perusahaan` text DEFAULT NULL,
  `no_telepon_email` varchar(128) DEFAULT NULL,
  `fotokopi_ktp` varchar(255) NOT NULL,
  `pas_foto` varchar(255) NOT NULL,
  `sertifikat_pelatihan` varchar(255) NOT NULL,
  `fotokopi_ijazah` varchar(255) NOT NULL,
...
INSERT INTO `tbl_form` (`id`, `skema`, `tuk`, `nama_kampus`, `nama_lengkap`, `nik`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `kebangsaan`, `email`, `no_telepon`, `pendidikan_terakhir`, `alamat_rumah`, `nama_pekerjaan`, `nama_perusahaan`, `jabatan`, `alamat_perusahaan`, `no_telepon_email`, `fotokopi_ktp`, `pas_foto`, `sertifikat_pelatihan`, `fotokopi_ijazah`, `tanggal`, `tanda_tangan`) VALUES
(1, 'Skema 1', 'TUK 1', 'a', 'Dede Herman', '3207181302860001', 'ciamis', '2000-12-12', 'Laki-Laki', 'indonesia', 'stmik@stmik.com', '081287015711', 'SMA', '232', 'Pekerjaan 1', 'daqu', 'IT', 'tangerang', '0811232', '353fb522a91cb158a7fd12cdf962d373.png', '2b1a0e518b822bd8ce64ee8266f032e1.png', 'e9dc2fe9761ede2f8d8eddfae2be62f9.png', '6ab28b0a23fb3b0eab4ab820ccf62633.png', '2000-12-12', 'Dede Herman'),
(2, 'Skema 1', 'TUK 1', 'stmik', 'Dede Herman', '3207181302860001', 'ciamis', '2000-02-12', 'Laki-Laki', 'indonesia', 'akunenggalabdi@gmail.com', '081287015711', 'SMA', 'tangerang', 'Pekerjaan 1', 'daqu', 'IT', 'tangerang', 'stmik@stmik.com', '400304f5b66ade32a088defec45e0216.png', 'd84876a38b30746c5a76f98d1337e19c.png', '5d8b257a157352b8799e1622c599cf0b.png', '92de64dfc71f3291d9d2d55b036af23b.png', '2000-12-12', 'Dede Herman'),
(3, 'Skema 1', 'TUK 1', 'stmik', 'Dede Herman', '3207181302860001', 'ciamis', '2000-02-12', 'Laki-Laki', 'indonesia', 'akunenggalabdi@gmail.com', '081287015711', 'SMA', 'tangerang', 'Pekerjaan 1', 'daqu', 'IT', 'tangerang', 'stmik@stmik.com', 'abb737b7317ef97ac6c1e3980ff1045f.png', '19ccab494e4bbae17b219b297e268273.png', '900053c77bb8cda2a6b4a0a56a666abf.png', 'fa2267a36455b28e4e5aa12658578d1b.png', '2000-12-12', 'Dede Herman'),
(4, 'Skema 1', 'TUK 1', 'stmik', 'Dede Herman', '3207181302860001', 'ciamis', '2000-02-12', 'Laki-Laki', 'indonesia', 'akunenggalabdi@gmail.com', '081287015711', 'SMA', 'tangerang', 'Pekerjaan 1', 'daqu', 'IT', 'tangerang', 'stmik@stmik.com', '8406638b2f11b9b62635fa295979dcee.png', '67c915d179b450303f311ccc1484b2c1.png', 'a33c363b55914413c570cbba303b889a.png', '325db7e2c7e00eb06b3ea3781e0d0fc8.png', '2000-12-12', 'Dede Herman'),
(5, 'Skema 1', 'TUK 1', 'stmik', 'Dede Herman', '3207181302860001', 'ciamis', '2000-12-12', 'Laki-Laki', 'indonesia', 'akunenggalabdi@gmail.com', '081287015711', 'SMA', 'tangerang', 'Pekerjaan 1', 'daqu', 'IT', 'tangerang', 'stmik@stmik.com', '0624d87a4dcda8744967b09da87e1790.png', '33a6fe34ae778b7e3fba4f03ee74c3fc.png', 'c2fdea2f877cfd1cffda1dedb0b500ad.png', 'd92a02b5686cd5c8b08cbff157643d75.png', '2000-12-12', 'Dede Herman'),
(6, 'Skema 1', 'TUK 1', 'stmik', 'Dede Herman', '3207181302860001', 'ciamis', '2000-12-12', 'Laki-Laki', 'indonesia', 'akunenggalabdi@gmail.com', '081287015711', 'SMA', 'tangerang', 'Pekerjaan 1', 'daqu', 'IT', 'tangerang', '0812112122', 'e706e52ef302afe24dbd7bcb50ad9424.png', '93069037c2f86c9092e7bb871ed811ec.png', '039caac2672957e3fffcb6670de17a6f.png', '38a4f296c50f9ed184269c7ea631d248.png', '2000-12-12', 'Dede Herman');
...
--
-- Table structure for table `tbl_hasilasesmen`
--

CREATE TABLE `tbl_hasilasesmen` (
  `no` int(11) NOT NULL,
  `hasil_asesmen` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_hasilasesmen`
--

INSERT INTO `tbl_hasilasesmen` (`no`, `hasil_asesmen`) VALUES
(1, 'Form Absensi Asesi');
...
INSERT INTO `tbl_jadwal` (`no`, `tanggal`, `skema`, `tuk`) VALUES
(1, '2024-07-20', 'PEMASARAN DIGITAL.', 'UNIVERSITAS DJUANDA');
...
(10, 'harviacode', 'harviacode', 'fa fa-user', 0, 'y'),
(14, 'Data TUK', 'data_tuk', 'fa fa-user', 0, 'y'),
(15, 'Jadwal Sertifikasi', 'jadwal', 'fa fa-user', 0, 'y'),
(16, 'Pilih Skema Sertifikasi', 'pilih_skema', 'fa fa-user', 0, 'y'),
(17, 'Update Data Pembayaran', 'pembayaran', 'fa fa-money', 0, 'y'),
(19, 'Pra Asesmen', 'pra_asesmen', 'fa fa-user', 0, 'y'),
(20, 'Asesmen', 'asesmen', 'fa fa-user', 0, 'y'),
(21, 'Hasil Proses Asesmen', 'hasilasesmen', 'fa fa-user', 0, 'y'),
(22, 'Umpan Balik', 'umpan', 'fa fa-user', 0, 'y'),
(23, 'Sertifikat BNSP Digital', 'sertifikat', 'fa fa-user', 0, 'y'),
(24, 'Skema', 'skema', 'fa fa-user', 0, 'y'),
(25, 'Form', 'form', 'fa fa-form', 0, 'y');
...
INSERT INTO `tbl_pembayaran` (`no`, `nama`, `biaya`, `keterangan`) VALUES
(1, 'Budi', 'Rp. 1.500.000', 'Lunas');
...
INSERT INTO `tbl_peserta` (`id`, `nama`, `nik`, `nomor_hp`) VALUES
(1, 'Dede Herman', '3207181302860001', '0812320000');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_pilih_skema`
--

CREATE TABLE `tbl_pilih_skema` (
  `no` int(11) NOT NULL,
  `skema` varchar(300) NOT NULL,
  `biaya` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_pilih_skema`
--

INSERT INTO `tbl_pilih_skema` (`no`, `skema`, `biaya`) VALUES
(1, 'Skema Sertifikasi Profesi Guru Tahsin Al-Qur’an Mubtadi (Muda)', '-'),
(2, 'Skema Sertifikasi Profesi Guru Tahsin Al-Qur’an Mubtadi (Madya)', '-'),
(3, 'Skema Sertifikasi Profesi Guru Tahsin Al-Qur’an Mubtadi (Mahir)', '-'),
(4, 'Skema Sertifikasi Profesi Guru Tahfizh Al-Qur’an Mubtadi (Muda)', '-'),
(5, 'Skema Sertifikasi Profesi Guru Tahfizh Al-Qur’an Mubtadi (Madya)', '-'),
(6, 'Skema Sertifikasi Profesi Guru Tahfizh Al-Qur’an Mubtadi (Mahir)', '-');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_pra_asesmen`
--

CREATE TABLE `tbl_pra_asesmen` (
  `no` int(11) NOT NULL,
  `pra_asesmen` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_pra_asesmen`
--

INSERT INTO `tbl_pra_asesmen` (`no`, `pra_asesmen`) VALUES
(1, 'Dokumen APL 01'),
(2, 'Isi Form APL 02'),
(3, 'Jadwal Verivikasi TUK');
...
CREATE TABLE `tbl_skema` (
  ...
  `nama_skema` varchar(128) NOT NULL,
  `gambar_skema` varchar(255) NOT NULL,
  `kategori_skema` varchar(128) NOT NULL,
  `jenis_skema` enum('KKNI','Cluster','Okupasi','') NOT NULL,
  `deskripsi` text NOT NULL,
  `kode_skema` varchar(128) NOT NULL,
  `unit_kompetensi` int(11) NOT NULL,
  `harga_skema` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_skema` (`id_skema`, `nama_skema`, `gambar_skema`, `kategori_skema`, `jenis_skema`, `deskripsi`, `kode_skema`, `unit_kompetensi`, `harga_skema`) VALUES
(1, 'Skema Sertifikasi Profesi Guru Tahsin Al-Qur’an Mubtadi (Muda)', 'https://i.ibb.co.com/L5mTD1C/1-Tahsin-Muda.png', 'Tahsin', 'Okupasi', 'Menyebutkan contoh-contoh wakaf ikhtiari&nbsp;', 'DQ 01', 20, 400000),
(2, 'Skema Sertifikasi Profesi Guru Tahsin Al-Qur’an Mutawassit (Madya)', 'https://i.ibb.co.com/vYRhd5j/2-Tahsin-Madya.png', 'Tahsin', 'Okupasi', '<p><br></p><p>Tahsin Madya</p>', 'DQ 02', 20, 400000),
(3, 'Skema Sertifikasi Profesi Guru Tahsin Al-Qur’an Mahir(Ahli)', 'https://i.ibb.co.com/7vKBGvY/3-Tahsin-Mahir.png', 'Tahsin', 'Okupasi', '<p>Tahsin</p>', 'DQ 03', 20, 400000),
(4, 'Skema Sertifikasi Profesi Guru Tahfizh Al-Qur’an Mubtadi (Muda)', 'https://i.ibb.co.com/ncbGD60/4-Tahfizh-Muda.png', 'Tahfizh', 'Okupasi', '<p>Tahfizh</p>', 'DQ 04', 20, 400000),
(5, 'Skema Sertifikasi Profesi Guru Tahfizh Al-Qur’an Mutawassit (Madya)', 'https://i.ibb.co.com/TLdN0zM/5-Tahfizh-Madya.png', 'Tahfizh', 'Okupasi', '<p>Tahfizh</p>', 'DQ 05', 20, 400000),
(6, 'Skema Sertifikasi Profesi Guru Tahfizh Al-Qur’an Mahir (Ahli)', 'https://i.ibb.co.com/DzBpz2g/6-Tahfizh-Mahir.png', 'Tahfizh', 'Okupasi', '<p>Tahfizh</p>', 'DQ 06', 20, 400000);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_umpan`
--

CREATE TABLE `tbl_umpan` (
  `no` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_user` (`id_users`, `full_name`, `email`, `password`, `images`, `id_user_level`, `is_aktif`, `idcard`) VALUES
(1, 'Super Admin', 'superadmin@gmail.com', '$2y$04$Wbyfv4xwihb..POfhxY5Y.jHOJqEFIG3dLfBYwAmnOACpH0EWCCdq', 'atomix_user31.png', 1, 'y', 0),
(3, 'Admin', 'admin@gmail.com', '$2y$04$Wbyfv4xwihb..POfhxY5Y.jHOJqEFIG3dLfBYwAmnOACpH0EWCCdq', '7.png', 2, 'y', 0),
(11, 'User', 'user@gmail.com', '$2y$10$dwb7SxEjvA68BHY12F60pe6jk3I4jt24OTNjW2zezeWr7DQdo4t6O', 'default.jpg', 5, 'y', 123);
...
--
-- Indexes for table `tbl_data_tuk`
--
ALTER TABLE `tbl_data_tuk`
  ADD PRIMARY KEY (`no`);
...
--
-- Indexes for table `tbl_hasilasesmen`
--
ALTER TABLE `tbl_hasilasesmen`
  ADD PRIMARY KEY (`no`);
...
--
-- Indexes for table `tbl_pilih_skema`
--
ALTER TABLE `tbl_pilih_skema`
  ADD PRIMARY KEY (`no`);

--
-- Indexes for table `tbl_pra_asesmen`
--
ALTER TABLE `tbl_pra_asesmen`
  ADD PRIMARY KEY (`no`);
...
--
-- Indexes for table `tbl_umpan`
--
ALTER TABLE `tbl_umpan`
  ADD PRIMARY KEY (`no`);
...
--
-- AUTO_INCREMENT for table `tbl_data_tuk`
--
ALTER TABLE `tbl_data_tuk`
...
--
-- AUTO_INCREMENT for table `tbl_hasilasesmen`
--
ALTER TABLE `tbl_hasilasesmen`
  MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tbl_pilih_skema`
--
ALTER TABLE `tbl_pilih_skema`
  MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_pra_asesmen`
--
ALTER TABLE `tbl_pra_asesmen`
  MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `tbl_umpan`
--
ALTER TABLE `tbl_umpan`
  MODIFY `no` int(11) NOT NULL AUTO_INCREMENT;
