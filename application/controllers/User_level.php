...
class User_level extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','user_level/tbl_user_level_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nama_level' => $row->nama_level,
            ...
            $this->template->load('template','user_level/tbl_user_level_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','user_level/tbl_user_level_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2024-08-07 19:04:30 */
/* http://harviacode.com */