...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-logo">
            <a href="<?php echo base_url(); ?>"><b> LSP </b>DAARUL QUR'AN </a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <?php echo anchor('auth/registration', '<i class="" aria-hidden="true"></i> Daftar', array('class' => 'btn btn-primary btn-block btn-flat')); ?>
                </div>
            </div>
            <!-- /.col -->
