        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <!-- <?= anchor(base_url('pilih_skema'), 'Lihat Unit Kompetensi dan Lakukan Pembayaran', 'class="btn btn-primary btn-block"'); ?> -->
                    <div class="box-body">
                        <div class='row'>
                            <div class='col-md-9'>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center" width="200px">
                                            ...
                                            // echo '  ';
                                            echo anchor(site_url('jadwal/update/' . $jadwal->no), '<i class="fa fa-calendar" aria-hidden="true"></i> Ajukan Perubahan Jadwal', 'class="btn btn-warning btn-sm"');
                                            echo '  ';
